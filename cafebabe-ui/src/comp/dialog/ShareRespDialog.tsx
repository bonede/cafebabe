    ...
    return <Dialog onClose={props.onClose} isOpen={props.shareResp !== undefined} title="Share"  className="bp4-dark">
        <DialogBody>
            <div className="bp4-text-large">
                ...
                <p>Deleting Link</p>
                <p className="bp4-monospace-text"><a href={props.shareResp?.deletingUrl} target="_blank">{props.shareResp?.deletingUrl}</a> <CopyButton content={props.shareResp?.deletingUrl} /></p>
            </div>
        </DialogBody>
