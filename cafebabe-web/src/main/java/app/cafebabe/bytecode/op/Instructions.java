...
import app.cafebabe.bytecode.classimage.attribute.CONSTANT_Long_info;
import app.cafebabe.bytecode.classimage.attribute.Code_attribute;
import app.cafebabe.bytecode.classimage.constant.*;
import app.cafebabe.bytecode.classimage.method_access_flag;
import app.cafebabe.bytecode.classimage.method_info;
import app.cafebabe.bytecode.vm.HeapObject;
    ...
    */
    ...
    public static class invokespecial implements Instruction{
        ...
        public void execute(Vm vm) {
            ...
            int ref = vm.popOpRef();
            DescriptorParser.MethodType methodType = (DescriptorParser.MethodType) DescriptorParser.parse(methodDescriptor);
            List<Object> params = new ArrayList<>();
            for(int i = 0; i < methodType.getParams().size(); i++){
                DescriptorParser.FieldType fieldType = methodType.getParams().get(0);
    ...
    public static class invokestatic implements Instruction{
        ...
        public void execute(Vm vm) {
            ...
            if(method.access_flags().contains(method_access_flag.ACC_NATIVE)){
                if(methodType.getReturnType().getTag() == DescriptorParser.FieldTag.V){
                    vm.increasePc(getSize());
                    return;
                }
    ...
    public static class putstatic implements Instruction{
        ...
        public void execute(Vm vm) {
            ...
            DescriptorParser.FieldType fieldType = (DescriptorParser.FieldType) DescriptorParser.parse(fieldDescriptor);
    ...
    public static class getfield implements Instruction{
        ...
        public void execute(Vm vm) {
            ...
            DescriptorParser.FieldType fieldType = fieldRef.getFieldType();
            if(heapObject == null){
